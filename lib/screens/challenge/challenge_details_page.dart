...
class ChallengeDetailsPage extends StatefulWidget {
  const ChallengeDetailsPage({super.key, required this.budgetId});

  final String budgetId;

  @override
  State<ChallengeDetailsPage> createState() => _BudgetDetailsState();
}

class _BudgetDetailsState extends State<ChallengeDetailsPage> with RouteAware {
