...
List<Widget> renderHeadingActions(BuildContext context, bool isMember, String budgetId) {
  List<Widget> actions = [
    IconButton(
    ...
    Future.microtask(() async {
      ...
      await handleMainPageApi(context, () async {
        ...
        setState(() {
          ...
          isMember = _budget.hostedBy.toString() != Provider.of<AuthService>(context, listen: false).user?.id;
          isLoading = false;
        });
      });
    });
